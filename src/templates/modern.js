...
<html><head><style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  <div class="center">
    ...
    <div style="font-size: 16px; font-weight: 800; color: #1a1a2e; letter-spacing: 0.5px;">${data.store_name || "STORE"}</div>
    <div style="color:#666;font-size:11px;">${data.store_address || ""}</div>
    <div style="color:#666;font-size:11px;">${data.store_phone ? "Telp: " + data.store_phone : ""}</div>
  </div>
  <div class="sep"></div>
